function LightBtn({children = "Error: Children can't be empty", variant = "primary", onClick, customClass}) {
    ...
    return (
        <button onClick={onClick} className={`${base} ${variants[variant]} ${customClass}`}>{children}</button>
    )
}
